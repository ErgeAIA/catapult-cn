...
See [CHANGELOG.md](CHANGELOG.en.md) for a list of notable changes between releases.

## Architecture

See [ARCHITECTURE.en.md](ARCHITECTURE.en.md) for detailed technical documentation covering the IPC pattern, data directories, runtime/model/server subsystems, and more.
